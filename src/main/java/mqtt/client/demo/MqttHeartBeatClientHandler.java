...
public class MqttHeartBeatClientHandler extends ChannelInboundHandlerAdapter {
  ...
  public MqttHeartBeatClientHandler(String clientId, String userName,
      String password) {
  ...
  public void channelActive(ChannelHandlerContext ctx) throws Exception {
    ...
    MqttConnectVariableHeader connectVariableHeader
        = new MqttConnectVariableHeader(PROTOCOL_NAME_MQTT_3_1_1,
            PROTOCOL_VERSION_MQTT_3_1_1, true, true, false, 0, false, false,
            20, MqttProperties.NO_PROPERTIES);
    MqttConnectPayload connectPayload = new MqttConnectPayload(clientId,
        MqttProperties.NO_PROPERTIES, null, null, userName, password);
    MqttConnectMessage connectMessage = new MqttConnectMessage(
        connectFixedHeader, connectVariableHeader, connectPayload);
  ...
  public void userEventTriggered(ChannelHandlerContext ctx, Object evt)
    ...
    if (evt instanceof IdleStateEvent) {
      MqttFixedHeader pingreqFixedHeader = new MqttFixedHeader(
