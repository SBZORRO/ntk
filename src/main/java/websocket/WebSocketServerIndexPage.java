...
public final class WebSocketServerIndexPage
{
  ...
  {
    return Unpooled
      .copiedBuffer("<html><head><title>Web Socket Test</title></head>"
        + NEWLINE + "<body>" + NEWLINE + "<script type=\"text/javascript\">"
        + NEWLINE + "var socket;" + NEWLINE + "if (!window.WebSocket) {"
        + NEWLINE + "  window.WebSocket = window.MozWebSocket;" + NEWLINE + '}'
        ...
        + NEWLINE + "</form>" + NEWLINE + "</body>" + NEWLINE + "</html>"
